...
CREATE TABLE `git_project_creds` (
  ...
  UNIQUE KEY `repository_name_UNIQUE` (`repository_name`),
...
CREATE TABLE `issue` (
  ...
  CONSTRAINT `user_ass_issue_id_frk` FOREIGN KEY (`user_assignee_id`) REFERENCES `participant` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user_cr_issue_id_frk` FOREIGN KEY (`user_creator_id`) REFERENCES `participant` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `issue_comment` (
  ...
  CONSTRAINT `user_cr_com_id_frk` FOREIGN KEY (`user_creator_id`) REFERENCES `participant` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project` (
  ...
  CONSTRAINT `user_cr_project_id_frk` FOREIGN KEY (`user_creator_id`) REFERENCES `participant` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-02-02  0:34:34
