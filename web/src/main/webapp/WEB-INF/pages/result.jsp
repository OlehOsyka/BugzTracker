    ...
    <jsp:body>
        <div class="col-md-6 col-md-offset-3" style="margin-top: 20%">
            ...
            <div class="alert alert-danger alert-danger-position ${error eq null? 'non-visible':''}"
                 role="alert">${error}<a href="<c:url value="/signup"/>"> Sign up</a>!
            </div>
            <div class="alert alert-success alert-danger-position ${success eq null? '':'non-visible'}"
                 role="alert">${success}<a href="<c:url value="/"/>"> Sign in</a>!
            </div>
        </div>
    </jsp:body>
</t:template>
